...
int                 errorCode = USBOPEN_ERR_NOTFOUND;
        ...
        for(dev = bus->devices; dev; dev = dev->next){  /* последовательный опрос всех устройств на всех шинах */
            if((vendorID == 0 || dev->descriptor.idVendor == vendorID)
                ...
                if(!handle)
                {
                    ...
                    if(warningsFp != NULL)
                    {
						//предупреждение о невозможности открыть устройство
 ...
 usb_strerror());
                ...
                if(len < 0){
                    ...
                    if(warningsFp != NULL)
                    {
												//предупреждение о невозможности запросить производител€
                    ...
                    if(shellStyleMatch(vendor, vendorNamePattern)){
                        ...
                        if(len < 0){
                            ...
                            if(warningsFp != NULL)
                            {
								//предупреждение о невозможности запросить данные продукта
                            ...
                            if(shellStyleMatch(product, productNamePattern)){
                                ...
                                if(len < 0)
                                {
                                    ...
                                    if(warningsFp != NULL)
                                    {
										//предупреждение о невозможности запросить серийный номер																				
